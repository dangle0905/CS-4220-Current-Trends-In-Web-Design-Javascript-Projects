...
// requiring in the router handler file for snippets/search
...
app.get('/', (req, res) => {
    res.send('Welcome to the Ball Dont Lie App');
});
...
client.connect((err) => {
    ...
    // storing the database instance in the app.locals object to reference in user.js and snippets.js
